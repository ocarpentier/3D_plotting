...
fig2 = ThreeDplot.plotter(matrix,'Test Title','x-axis','y-axis',colormp='hsv',fontsize=15,font=None,couleur=True,grid=True,ticks=True)
fig1.planeinterval = 10                 # Most likely there wont be many points having exactly the same value hence all the points lying in the interval will be projected on the plane this is how its adjusted
fig2.planeinterval = 1                 # same
# fig1.intersectingplanes(5,5)
fig2.streamsplanexz(5,density=2)
